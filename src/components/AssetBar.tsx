...
export default function AssetBar() {
  ...
  const isFav = currentMarket ? favorites.includes(currentMarket.id) : false;
    ...
    <>
      <div className="assetbar-wrap">
        <div className="assetbar">
          ...
          <div className="asset-pick-btn" onClick={() => { resumeAudio(); playClick(); setShowMarkets(true); }}>
            ...
            <div>
              ...
              <div className="asset-pick-sub-row">
                <span className="asset-pick-cat">{currentMarket.category} · {currentMarket.payout}%</span>
          ...
          {/* Favorite toggle */}
          <button
            className={`asset-fav-btn ${isFav ? 'active' : ''}`}
          ...
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill={isFav ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>
          </button>
          ...
          {/* Open pair tabs — drag/scroll horizontally once there are more
              than fit on screen */}
            ...
            <div className="countdown-ring">
              <svg width="32" height="32" viewBox="0 0 32 32">
                ...
                <circle
                  className="fill"
                  cx="16" cy="16" r="12"
                  strokeDasharray={`${perc * 2 * Math.PI * 12} ${2 * Math.PI * 12}`}
