...
// Only these are shown as pills in the toolbar (matches the reference
// design's 5-button row) — the rest of TFS above still exists for internal
// data-fetch logic, just isn't exposed as a button.
const PRIMARY_TFS: TF[] = ['1m','5m','15m','30m','1h'];
