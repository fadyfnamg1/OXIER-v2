...
export default function TopBar() {
  ...
  return (
    <div className="topbar">
      {/* Logo — OXIER wordmark, orange X, small tagline beneath (matches
          reference "BINARY OPTIONS" subtitle) */}
      <div className="tb-logo">
        <div>
          <OxierLogo size={16} />
          <div className="tb-logo-sub">Binary Options</div>
        </div>
      </div>
      ...
      <div className="tb-right">
        ...
        <div style={{ position: 'relative' }} ref={dropRef}>
          <div
            className={`tb-wallet ${dropOpen ? 'open' : ''} tb-wallet-${walType}`}
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.15 }}>
              <span className="tb-wallet-label">
                {balanceHidden ? 'Balance' : (walType === 'demo' ? t('app.wallet.demo') : walType === 'challenge' ? 'Challenge' : t('app.wallet.real'))} account
              </span>
